...
// Teste unitário que verifica cada operação disponível na calculadora
class CalculatorTest extends TestCase
{
    private $calculator;

    // setUp roda antes de cada teste e garante um objeto pronto para uso
    protected function setUp(): void
    {
        $this->calculator = new Calculator();
    }

    // Confere se a função add soma corretamente
    ...
    // Valida várias divisões normais
    ...
    // Garante que dividir por zero dispara a exceção esperada
    ...
    // Os testes abaixo exigem que a classe Calculator tenha os métodos extras correspondentes
