...
// Caso já esteja autenticado, manda direto para o painel
...
if ($_POST) {
    ...
    if (empty($email) || empty($senha)) {
        ...
        try {
            // Busca apenas um usuário com o email e senha informados
...
<body>
    <div class="login-container">
        <!-- Formulário envia email e senha via POST para validar o usuário -->
        <form method="POST">
