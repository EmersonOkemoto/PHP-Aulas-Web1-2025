...
// Carrega a lista completa de produtos do arquivo JSON
$products = loadProducts();

// Variáveis de apoio para mensagens, filtro e cadastro do usuário logado
$message = "";
$categoria_filtro = $_COOKIE["categoria_filtro"] ?? 'todas';
$username = $_SESSION["username"] ?? '';

// Carrinho fica guardado na sessão para persistir entre requisições
$carrinho = $_SESSION['carrinho'] ?? [];

if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['login'])) {
        // Salva o nome do usuário na sessão quando ele envia o formulário
    ...
    if (isset($_POST['logout'])) {
        // Limpa toda a sessão para “deslogar” o usuário
        session_destroy();
        $username = "";
    ...
    if (isset($_POST['filter'])) {
        // Guarda o filtro de categoria no cookie para lembrarmos depois
    ...
    if (isset($_POST["add-cart"])) {
        ...
        if ($produto_selecionado) {
            // Se o produto já está no carrinho, apenas somamos a quantidade
    ...
    if(isset($_POST["clear-cart"])) {
        // Botão que zera o carrinho inteiro
...
// Cria a lista de categorias distintas para preencher o select do filtro
...
<body>
    <div class="container">
        <div class="header">
            <!-- Cabeçalho mostra título e bloco de login -->
            <div>
                <h1>Loja Online</h1>
            </div>
            <div class="user-info">
        ...
        <div class="grid">
            <div class="carrinho-section">
                ...
                <?php else:
                    ...
                    <?php foreach ($carrinho as $item):
                        ...
                        ?>
                        <!-- Item do carrinho mostrando quantidade e botão de remoção -->
            ...
            <div class="produtos-section">
                ...
                <div class="filtro">
                    <!-- Formulário que envia o valor escolhido para salvar o filtro -->
                    <form method="POST">
                ...
                <div class="produtos-grid">
                    <!-- Cada cartão mostra dados básicos do produto e o botão de compra -->
