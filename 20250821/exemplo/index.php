...
// Lê o arquivo JSON e transforma em array associativo
...
// Salva o array de usuários de volta no arquivo
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($nome && $email && $idade) {
        // Incrementa o ID com base no total atual
...
// Termo usado para filtrar resultados por nome ou email
...
<body>
    <div class="container">
        ...
        <div class="content">
            <?php if ($message): ?>
                <!-- Classe muda dependendo se a mensagem contém a palavra sucesso -->
