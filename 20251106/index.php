...
// Flags usadas para mostrar o status das extensões e drivers
...
// Faz uma conexão em memória apenas para validar o PDO
try {
...
<body>
    <div class="container">
        <!-- Bloco que lista o status das extensões e drivers -->
