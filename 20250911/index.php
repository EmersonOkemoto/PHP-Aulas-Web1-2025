...
// Cria a lista de animais na sessão se ainda não existir
...
// Opções permitidas no formulário select
        ...
        switch ($_POST['acao']) {
            case 'inserir':
                if (!empty($_POST['nome']) && !empty($_POST['especie']) && !empty($_POST['idade'])) {
                    // Verifica se a espécie selecionada é válida
...
<body>
    <div class="container">
        <div class="form-container">
            <?php if ($mensagem): ?>
                <!-- Caixa de feedback mostra sucesso ou erro -->
                        ...
                        <tr>
                            ...
                            <td class="acoes">
                                <form method="POST" class="form-inline">
                                    ...
                                    <!-- Botão envia o ID correto para remover o registro da sessão -->
